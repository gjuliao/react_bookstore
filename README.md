...
**[React Bookstore]** Is a react bookstore app to search and store books.
...
1. Download the **Zip** file or clone the repo with:
   `bash git clone git@github.com:gjuliao/react_bookstore.git`
2. To access cloned directory run:
   `bash cd react_bookstore `
...
Feel free to check the [issues page](https://github.com/gjuliao/react_bookstore/issues).
